 ...
 * @author fotso
 */
public class calculReasultatOrderImpl implements calculReasultat {

    public Tools tools;
    // public Utilitaire_order utilitaire;

    public calculReasultatOrderImpl() {
    }

    public calculReasultatOrderImpl(Tools tools) {
        this.tools = tools;
    ...
    public void compareTime(boolean[][] mat, int[] memory) {
        ...
        int max1 = Utilitaire_order.computeSupport(mat, memory);
    ...
    public Resultat compareTimealg1_trie(boolean[][] mat, int[] memory) {
        initMatMemory(mat, memory);
        long start1 = System.currentTimeMillis();
        int max1 = Utilitaire_order.computeSortLeafSupport(mat, memory);
        long end1 = System.currentTimeMillis();
        long diff1 = end1 - start1;
