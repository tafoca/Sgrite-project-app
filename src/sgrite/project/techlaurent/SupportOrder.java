...
public class SupportOrder {
    ...
    public calculReasultatOrderImpl getReasultatImpl() {
        return reasultatImpl;
    }

    public void setReasultatImpl(calculReasultatOrderImpl reasultatImpl) {
...
//        System.out.println("********************************************************************************************************");
//        boolean[][] get = allMatrix.getAllContengent().get(205);//0,1,2,3,4,5,6
//
//        affiche(get);
//
...
//        System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++[" + get.length + "]");
    ...
    public void dataForDrawGraphe(String outputfile1, String outputfile2) throws IOException {
        ...
        for (boolean[][] mat : allContengent) {
            ...
            calculReasultatOrderImpl reasultat = new calculReasultatOrderImpl(new Tools());
