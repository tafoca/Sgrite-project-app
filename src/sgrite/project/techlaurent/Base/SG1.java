...
/**
 * Implementtaion of Method SG1 of SGrite
 *
 ...
 *
 */
public class SG1 extends CommonMethod {
    ...
    private String outputfile = "TimeSG1";
    ...
    public SG1() throws IOException {
        ...
        this.item = null;
        this.dataset = SG1.duplique(itemsets);
    ...
    public SG1(String[] params) throws IOException {
        super();
    ...
    public void exec(FileWriter fw2, FileWriter fw3) {
        ...
        for (int m = 1; m < attrList.length; m++) {
         ...
         System.out.println("SG1.exec(), number of gradual patterns extracted: " + getNumberPatterns());
        double duree = (System.currentTimeMillis() - startTime);
        System.out.println("SG1.exec() execution time (s) :" + duree / 1000.0 + "");
    ...
    public static void getAllColum(float[][] dataset, float[] item, int a, int taille) {
        for (a = 0; a < SG1.nbitems; a++) {
            float[] rescol = SG1.getDataColByCol(dataset, item, a, taille);
    ...
    private ArrayList<boolean[][]> createGradualsItemsetsOfSize1(float[][] dataset, float[] item, int a, int taille) {
        ...
        for (int i = 0; i < nbitems; i++) {
            float[] rescol = SG1.getDataColByCol(dataset, item, i, taille);
